		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#rogerinvoicesmaster-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rogerinvoicesmaster-display": {
								"semanticObject": "rogerinvoicesmaster",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=roger.invoicesmaster",
									"url": sap.ui.require.toUrl("roger/invoicesmaster")
								}
							}
						}
					}
